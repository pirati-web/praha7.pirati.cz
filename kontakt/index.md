...
description: Pirátská strana v Praze 7 je otevřená a ráda přivítá nové členy, dobrovolníky a odpoví na vaše dotazy
...
**Zajímá vás co děláme na sedmičce, a chtěli byste se zapojit?** Neváhejte a přijďte za námi na otevřenou (on-line či off-line) schůzi. Potkáváme se pravidelně, přesná data najdete v našem <a href="{{site.calendar.page}}">kalendáři</a>. Těšíme se na viděnou.

**Komunikujeme pravidelně na Facebooku**, najdete nás jako [Piráti Praha 7](https://www.facebook.com/PiratiPraha7/). Webové stránky pražského sdružení najdete na [praha.pirati.cz](https://praha.pirati.cz/).
...
<h4>Podpořte nás!</h4>
- Finanční dary na podporu našeho fungování můžete posílat na [dary.pirati.cz](https://dary.pirati.cz/podpor-kraj/praha/adresne-dary-pro-ks-praha/), kde vyberete Jiný účel: MS Praha 7 (nebo specifický symbol 110110).
